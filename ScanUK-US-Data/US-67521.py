...
from config import TOTAL_PAGES  # Import the TOTAL_PAGES variable from config.py
        ...
        while True:
            ...
            if data:
                ...
                if processed_items:
                    ...
                    print(f"=============Page {page} Completed inserting in {time_taken:.2f} seconds")
                    page += 1
            else:
                print(f"Failed to retrieve data for page {page}. Exiting loop.")
                break

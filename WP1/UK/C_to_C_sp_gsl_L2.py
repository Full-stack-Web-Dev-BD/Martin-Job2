# Insert Data from Uk Daily Data to Sp Upc Lookup 2 table ( Mongo)
...
def fetch_and_update_sp_gsl_lookup2():
    print(f"Number of documents in uk_daily_data: {count} Updating for sp_gsl_lookup2")
    try:
...
# Call the fetch_and_update_sp_gsl_lookup2 function

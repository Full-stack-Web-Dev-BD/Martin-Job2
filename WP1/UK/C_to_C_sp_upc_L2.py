...
def fetch_and_update_sp_upc_lookup2():
    print(f"Number of documents in uk_daily_data: {count} Updating for sp_upc_lookup2")
...
# Call the fetch_and_update_sp_upc_lookup2 function

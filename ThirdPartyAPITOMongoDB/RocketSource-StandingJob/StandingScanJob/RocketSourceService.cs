...
namespace RocketSource
{
    public class RocketSourceService : IRocketSourceService
    {
        ...
        public RocketSourceService(IConfigurationRoot config)
        {
        ...
        public void GetScanResult(int scanId)
        {
            try
            {
                ...
                var pageNumber = 1;
                var attempt = 1;
                List<StandingScanData> finalScanResults = new List<StandingScanData>();
                ...
                do
                {
                    ...
                    try
                    {
                        ...
                        if (rsResponse.IsSuccessStatusCode)
                        {
                            ...
                            var scans = _mapper.Map<List<StandingScanData>>(scanResults?.Data);

...
namespace RocketSource.Models
{
    ...
    public class AmazonFees
    {
        ...
        public int? fba_fees { get; set; }
        public object variable_closing_fee { get; set; }
    ...
    public class Data
    {
        ...
        public object lowest_price_new_fba { get; set; }
        public object lowest_price_used_fba { get; set; }
